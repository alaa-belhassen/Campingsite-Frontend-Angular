...
@Component({
  selector: 'app-afficher-une-reclamation-client',
  templateUrl: './afficher-une-reclamation-client.component.html',
  styleUrls: ['./afficher-une-reclamation-client.component.scss']
})
export class AfficherUneReclamationClientComponent implements OnInit {
  ...
  submitReply() {
    ...
    if (this.selectedOption) {
      this.reclamation.statutReclamation = 'Pending_Admin_Response';
